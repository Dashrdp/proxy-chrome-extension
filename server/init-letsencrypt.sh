...
domains=(proxyconf.api.dashrdp.cloud)
rsa_key_size=4096
data_path="./data/certbot"
email="dashrdp@gmail.com" # Adding a valid address is strongly recommended
...
echo "### API endpoints available at: https://proxyconf.api.dashrdp.cloud/api/"
